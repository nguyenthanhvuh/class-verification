...
You will write a ``blog'' describing full concrete example illustrating the DNN technique assigned to you. % This blog will be \textbf{due \textbf{2 weeks}} after your group is assigned the paper.  
