...
AI, in particular Deep Neural Networks (DNNs), have emerged as an effective approach for solving challenging real-world problems. Among many others, they have been used for image recognition, autonomous driving, airplane collision control,
...
In this class, we will learn various  a variety of techniques and tools to verify DNNs. We will cover topics including the applications
